...
const Overview = () => {
    ...
    return (
      <div className="flex justify-center items-center ml-auto mr-auto">
        <div role="status">
          <svg
            aria-hidden="true"
            class="w-10 h-10 text-gray-200 animate-spin dark:text-gray-600 fill-[#47e371]"
            viewBox="0 0 100 101"
            fill="none"
  ...
  return (
    <section className="grow grid grid-cols-2 pl-8 pt-8 gap-y-6 pb-8">
      <OverviewItem image={tempLogo} name="Temperature" value={data?.tc} />
      <OverviewItem
        image={humidityLogo}
        name="Humidity"
        value={`${data?.hu}%`}
